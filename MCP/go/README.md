# SpectroCoin Merchant MCP Server

This MCP (Model Content Protocol) server provides access to SpectroCoin Merchant API functionality through HTTP, HTTPS, and STDIO transport modes.
